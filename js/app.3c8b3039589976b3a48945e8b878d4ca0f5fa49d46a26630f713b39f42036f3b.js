...
(() => {
  ...
  var updateLogos = () => {
    ...
    const logos = {
      hf: {
        light: "images/logo-hf-light.png",
        dark: "images/logo-hf-dark.png"
      },
      entalpic: {
        light: "images/logo-entalpic-light.jpg",
        dark: "images/logo-entalpic-dark.png"
      }
    };
