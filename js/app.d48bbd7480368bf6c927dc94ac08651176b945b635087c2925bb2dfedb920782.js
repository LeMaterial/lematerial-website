...
(() => {
  ...
  var updateLogos = () => {
    ...
    const logos = {
      ...
      entalpic: {
        light: "https://github.com/LeMaterial/lematerial-website/blob/feat/images/assets/images/entalpict.png?raw=true",
