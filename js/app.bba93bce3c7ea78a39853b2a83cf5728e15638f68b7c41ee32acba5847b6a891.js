...
(() => {
        ...
        function l(window2, document2, Date2) {
          ...
          var debounce = function(func) {
            ...
            return function() {
              timestamp = Date2.now();
              if (!timeout) {
                timeout = setTimeout2(later, wait2);
              }
            };
          };
          var loader = function() {
  ...
  var updateLogos = () => {
    ...
    const htImg = document.getElementById("hf-logo");
    console.log("htImg :", htImg);
    const etImg = document.getElementById("entalpic-logo");
    console.log("etImg :", etImg);
    if (!htImg || !etImg) {
      return false;
    }
