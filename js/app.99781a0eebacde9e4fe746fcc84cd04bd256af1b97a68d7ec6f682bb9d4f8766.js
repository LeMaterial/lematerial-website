...
(() => {
  ...
  var updateLogos = () => {
    ...
    const logos = {
      hf: {
        light: "https://github.com/LeMaterial/lematerial-website/blob/feat/images/assets/images/hf-logo-light.jpg?raw=true",
        dark: "https://github.com/LeMaterial/lematerial-website/blob/feat/images/assets/images/hf-logo-dark.png?raw=true"
      },
      entalpic: {
        light: "https://github.com/LeMaterial/lematerial-website/blob/feat/images/assets/images/entalpic.png?raw=true",
        dark: "https://github.com/LeMaterial/lematerial-website/blob/feat/images/assets/images/entalpic.png?raw=true"
      }
    };
    const hfLogo = document.getElementById("hf-logo");
    const entalpicLogo = document.getElementById("entalpic-logo");
    if (hfLogo) document.getElementById("hf-logo").src = logos.hf[theme];
